...
public class FocusEnchantment extends Enchantment {
    protected FocusEnchantment(Rarity p_i46731_1_, EnchantmentType p_i46731_2_, EquipmentSlotType... p_i46731_3_) {
    ...
    protected boolean checkCompatibility(@Nonnull Enchantment p_77326_1_) {
        return super.checkCompatibility(p_77326_1_) && p_77326_1_ != TCombatEnchants.SNIPE.get();
    }
}
